...
import com.zhuinden.roomlivepagedlistproviderexperiment.application.injection.DaggerAppComponent;
...
public class CustomApplication
    ...
    public void onCreate() {
        ...
        // this is ugly here: providing initial data
        final TaskDao taskDao = appComponent.taskDao();
        if(taskDao.count() <= 0) {
            List<Task> taskList = new ArrayList<>(Tasks.values().length);
            Date date = new Date();
            ...
            taskDao.insert(taskList); // TODO: figure out how to make Room not expect ALL entities to be in a single list to insert in a single transaction...
        }
